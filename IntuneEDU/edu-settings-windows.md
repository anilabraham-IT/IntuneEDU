...
This article lists all Windows device settings in Intune for Education, and a description for each setting. To view these settings in the portal, click **Group** >**Settings** > **Windows Device Settings**. 
